...
def on_publish_received(publish_packet_data):
    ...
    received_count += 1
    print("{}{}".format("received_count sub2--", received_count))
...
client = mqtt5_client_builder.mtls_from_path(
        ...
        port=8883,
        cert_filepath="./certs/subs/sub2/sub2-certificate.pem.crt",
        pri_key_filepath="./certs/subs/sub2/sub2-private.pem.key",
